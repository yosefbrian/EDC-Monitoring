...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <title>EDC MONITORING &mdash;</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="description" content="We Connect About Agliculture" />
    <meta name="keywords" content="Bibitku" />
    <meta name="author" content="Bibitku" />
    ...
    <header role="banner" >
            <div class="container">
                ...
                <a href="#" class="navbar-left" style="margin-left: 30px"><img src="images/Logo.png"></a>
                </div>
        ...
        <div class="container">
            <div class="">
                <div class="col-md-12 text-center">
                    <p>Copyright Yosef Brian 2019</p>
